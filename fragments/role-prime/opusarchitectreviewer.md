## opusarchitectreviewer role context (v1 stub — full content in GIM-95b)

GIM-95b ships opusarchitectreviewer-specific extras. Until that slice merges, refer to
your role file (`paperclips/dist/opusarchitectreviewer.md`) for primary discipline.
