...
Useful tools:
- palace.code.get_code_snippet(qualified_name="...", project="{{CODEBASE_MEMORY_PROJECT}}") — read existing code before editing
- palace.code.search_graph(name_pattern="...", project="{{CODEBASE_MEMORY_PROJECT}}") — find similar implementations
- palace.code.trace_call_path(function_name="...", project="{{CODEBASE_MEMORY_PROJECT}}", mode="callees") — what would my edit affect
