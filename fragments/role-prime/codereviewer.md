## codereviewer role context (v1 stub — full content in GIM-95b)

GIM-95b ships codereviewer-specific extras. Until that slice merges, refer to
your role file (`paperclips/dist/codereviewer.md`) for primary discipline.
